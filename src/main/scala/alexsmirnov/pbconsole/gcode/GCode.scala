...
object GCode {
  ...
  sealed trait Move extends GCode {
    def x: Option[Float]
    def y: Option[Float]
    def z: Option[Float]
  ...
  case class G0Move(x: Option[Float], y: Option[Float], z: Option[Float], extruder: Option[Float], speed: Option[Float],command: String) extends Move 
  object G0Move {
    def apply(p: Map[Char, Float],command: String) = new G0Move(p.get('X'), p.get('Y'), p.get('Z'), p.get('E').orElse(p.get('A')), p.get('F'),command)
  }
  case class G1Move(x: Option[Float], y: Option[Float], z: Option[Float], extruder: Option[Float], speed: Option[Float],command: String) extends Move 
  object G1Move {
    def apply(p: Map[Char, Float],command: String) = new G1Move(p.get('X'), p.get('Y'), p.get('Z'), p.get('E').orElse(p.get('A')), p.get('F'),command)
  }
  case class G92SetPos(x: Option[Float], y: Option[Float], z: Option[Float], extruder: Option[Float],command: String) extends Move {
    val speed = None
  }
  object G92SetPos {
